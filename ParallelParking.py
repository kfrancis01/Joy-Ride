...
def control(pos_x, pos_y, time, velocity):
    ...
    if time >= 12.7:
        ...
        car_parameters['throttle'] = -1
    elif pos_y < 40.8 and pos_y > 40.6:
        car_parameters['throttle'] = -1
        car_parameters['steer'] = 1
    elif pos_y < 39 and pos_y > 34:
        car_parameters['throttle'] = -0.5
        car_parameters['steer'] = -0.3
    elif pos_y < 33 or pos_x > 130.9:
        car_parameters['throttle'] = 0.7
        car_parameters['steer'] = 0.45
    elif time > 10 and pos_y >= 29.5 and pos_x == 130.46:
        car_parameters['throttle'] = 0
        car_parameters['brake'] = 1
    # pos_y <= 31.8 and pos_x <= 131:
    return car_parameters
